/*
 ...
 This program tests the functionality of the fraction class. The fraction class
 allows a user to create fractions, do fraction arithmetic, print fractions as
 mixed numbers, compare fractions in conditionals, and enter fractions from 
 standard in all by using the standard C++ operators.
 */
